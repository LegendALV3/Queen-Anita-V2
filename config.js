...
global.devs = "919403621818";
global.sudo = process.env.SUDO || "919403621818";
global.owner = process.env.OWNER_NUMBER || "919403621818";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "LEGENDARY",
  author: process.env.PACK_AUTHER || "Legend",
  packname: process.env.PACK_NAME || "+919403621818",
